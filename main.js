...
var myBdGrid = document.getElementById('app');

// Titre de la page
var pageTitre = document.createElement('h1');
pageTitre.innerHTML = 'Les bandes dessinnées disponibles !';
myBdGrid.prepend(pageTitre);

// Création du panier d'emprunt  (+++)ajouter une icone panier a partir de font awesome
var monPanier = document.createElement('div');
monPanier.id = 'monPanier_id';
var monPanierTitre = document.createElement('h2');
monPanierTitre.innerHTML = 'Mon Panier';
monPanier.append(monPanierTitre);
myBdGrid.append(monPanier);

// Affichage des bds de la table
for (var el of bds) {
  ...
  // Bouton Emprunter bd
  var btnEmprunt = document.createElement('button');
  btnEmprunt.className = 'btnEmprunt_cl';
  btnEmprunt.innerHTML = 'Emprunter';
  bd.append(btnEmprunt);
  myBdGrid.append(bd);
